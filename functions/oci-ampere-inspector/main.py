...
def post_to_slack(blocks, thread_ts=None, channel=None, text="`oci-ampere-inspector`"):
                ...
                "blocks": [
                    {
                        ...
                        "fields": [
                            {
                                "type": "mrkdwn",
                                "text": f"Trying to create the ampere compute instance on OCI account `{di['OCI_ACCOUNT_NAME']}`",
                            }
                        ],
                    },
                ],
                        ...
                        "blocks": [
                            {
                                ...
                                "fields": [
                                    {
                                        "type": "mrkdwn",
                                        "text": f"An instance was created: {instance_id}",
                                    }
                                ],
                            },
                        ],
